...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_to(self):
        email = mail.outbox[0]
        expect = ['contato@eventex.com.br', 'omorenodovale@gmail.com']
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('Carlos Augusto Moreno R. Junior', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('omorenodovale@gmail.com', email.body)
        self.assertIn('68-99999-9999', email.body)
